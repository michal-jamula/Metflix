...
public class VideoStreamingService {
    ...
    public ResponseEntity<ResourceRegion> getVideoRegion(String rangeHeader , String directory, String videoName) throws IOException {
        FileUrlResource videoResource = new FileUrlResource(directory + videoName);
